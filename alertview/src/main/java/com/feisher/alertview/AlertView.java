...
public class AlertView {
    ...
    public void setMarginBottom(int marginBottom){
        ...
        int marginAlertLeftRight = context.getResources().getDimensionPixelSize(R.dimen.margin_alert_left_right);
        params.setMargins(marginAlertLeftRight,0,marginAlertLeftRight,marginBottom);
        contentContainer.setLayoutParams(params);
    }
